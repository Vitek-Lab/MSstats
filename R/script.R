...
#dataProcess with equalized median

summarized_normalized = dataProcess(msstats_format, featureSubset = "topN",n_top_feature = 20)
summarized_normalized_MbImputeFalse = dataProcess(msstats_format, featureSubset = "topN",n_top_feature = 20, MBimpute = FALSE)

#dataProcess with Normalization False
summarized_no_normalization = dataProcess(msstats_format, normalization = "FALSE")
summarized_no_normalization_MbImputeFalse = dataProcess(msstats_format, normalization = "FALSE", MBimpute = FALSE)

model_normalized = groupComparison("pairwise", summarized_normalized)
model_normalized_MbImputeFalse = groupComparison("pairwise", summarized_normalized_MbImputeFalse)
model_no_normalization = groupComparison("pairwise", summarized_no_normalization)
model_no_normalization_MbImputeFalse = groupComparison("pairwise", summarized_no_normalization_MbImputeFalse)

#TODO: with a contrast matrix


comparisonResult <- model_normalized$ComparisonResult
...
###################################################################################################################################
###########################################MS Stats results for Non Imputed Normalized Data###############################################
###################################################################################################################################
###################################################################################################################################

comparisonResult <- model_normalized_MbImputeFalse$ComparisonResult
...
###################################################################################################################################
###########################################MS Stats results for Non Normalized Data###############################################
###################################################################################################################################
###################################################################################################################################

comparisonResult <- model_no_normalization$ComparisonResult
...
###################################################################################################################################
###########################################MS Stats results for Non Normalized No MB Imputation Data###############################################
###################################################################################################################################
###################################################################################################################################

comparisonResult <- model_no_normalization_MbImputeFalse$ComparisonResult
