...
transformMSnSetToMSstats <- function(ProteinName, PeptideSequence, PrecursorCharge, FragmentIon,
  ...
  long.abundances <- reshape(expressionMatrix, idvar="fData_rownames",
...
transformMSstatsToMSnSet <- function(data) {
  ...
  featureNames(e) <- paste(fData(e)$PEPTIDESEQUENCE, fData(e)$PRECURSORCHARGE,
                           fData(e)$FRAGMENTION, fData(e)$PRODUCTCHARGE, sep = ".")
  if (validObject(e)){
    return(e)
  }
}
