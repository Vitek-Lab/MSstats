...
\begin{small}
<<QCplot, echo=FALSE, results=hide>>= 
...
\begin{small}
<<Profileplot, echo=FALSE, results=hide>>= 
...
\begin{small}
<<Conditionplot, echo=FALSE, results=hide>>= 
...
\begin{small}
<<groupComparisoneplot1, echo=FALSE, results=hide>>= 
...
\begin{small}
<<groupComparisoneplot2, echo=FALSE, results=hide>>= 
groupComparisonPlots(data=testResultMultiComparisons$ComparisonResult,
...
\vspace{-0.3cm}
\begin{small}
<<groupComparisoneplot5, echo=FALSE, results=hide>>=
groupComparisonPlots(data=testResultMultiComparisons$ComparisonResult,
                     type="ComparisonPlot")
@
\end{small}
